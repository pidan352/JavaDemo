package com.lyl.modules.common.validator.submit;

import com.lyl.config.Constants;
import com.lyl.modules.common.dto.output.ApiResult;
import com.lyl.utils.IpUtils;
import com.lyl.utils.RedisUtil;
...
public class NoRepeatSubmitAop {
     ...
     */
    @Around("execution(* com.lyl.modules.*.api.*Controller.*(..)) && @annotation(noRepeatSubmit)")
