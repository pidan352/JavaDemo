package com.lyl.modules.common.validator.fieldrepeat;
...
import com.lyl.modules.common.exception.MyException;
import com.lyl.utils.BeanUtil;
...
public class FieldRepeatValidatorUtils {
    ...
    public static boolean fieldRepeat(String id, String field, String fieldTwo, String twoValue, Object object, String message) {
        ...
        if (StringUtils.isBlank(fieldTwo)) {
            list = entity.selectList(new QueryWrapper().eq(true, db_field, fieldValue));
        } else {
            if (StringUtils.isNotBlank(twoValue)) {
                fieldTwoValue = twoValue;
            }
            list = entity.selectList(new QueryWrapper().eq(true, db_field, fieldValue).eq(true, db_field_two, fieldTwoValue));
        }
