...
import com.lyl.unionpay.sdk.CertUtil;
...
import static com.lyl.unionpay.sdk.SDKConstants.*;
import static com.lyl.unionpay.sdk.SDKUtil.*;
...
//		log.debug("read sign key from [" + certFilePath + "] pwd [" + certPwd + "]");
    ...
    public static void main(String[] args) {
        String certIdByKeyStoreMap = GmCertUtil.getCertIdByKeyStoreMap("d:/certs/sm2Cert.sm2", "up1699");
        System.out.println(certIdByKeyStoreMap);
    }
