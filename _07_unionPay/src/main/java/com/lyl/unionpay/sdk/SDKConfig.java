...
//	private String encryptTrackCertPath;
    ...
    // acp7
    public static final String V7_TRANS_URL = "acpsdk.v7TransUrl";
...
//		}
        ...
        value = pro.getProperty(V7_TRANS_URL);
        if (!SDKUtil.isEmpty(value)) {
            this.v7TransUrl = value.trim();
        }
